...
import android.graphics.Color;  // Importante para usar colores
...
public class ActivitiesAdapter extends RecyclerView.Adapter<ActivitiesAdapter.ActivityViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ActivityViewHolder holder, int position) {
        ...
        // Cambiar el color del botón según la disponibilidad de la actividad
        if (activity.isDisponibilitat()) {
            holder.btnSignUp.setBackgroundColor(Color.GREEN); // Disponible, color verde
        } else {
            holder.btnSignUp.setBackgroundColor(Color.RED); // No disponible, color rojo
        }
